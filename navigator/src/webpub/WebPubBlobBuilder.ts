...
export class WebPubBlobBuilder {
    ...
    private readonly injections?: WebPubInjections;

    constructor(pub: Publication, baseURL: string, item: Link, cssProperties?: { [key: string]: string }, injections?: WebPubInjections) {
        this.pub = pub;
        this.item = item;
